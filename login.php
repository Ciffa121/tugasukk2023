        ...
        <div class="card my-6">
            ...
            <h2 class="mb-3 mt-4 text-center" style="color:rgb(61, 61, 61);">L O G I N</h2>
              <div class="mb-3 mt-3 text-center">
                username : <br>
                <input class="rounded-3 border-light" type="text" name="nik" placeholder required
                style="width: 300px;">
              </div>
              <div class="mb-3 mt-3 text-center">
                password : <br>
                <input class="rounded-3 border-light" type="text" name="nama_lengkap" placeholder required
                style="width: 300px;">
              </div>
              <div class="text-center mt-3"> 
                <button type="submit" class="btn btn-success px-3 mb-3" style="width: 300px;">Login</button> <br>
                <p><i>Belum Punya Akun? Click <a href="form_register.php" class="text-danger">Register</a></i></p>
                </div>
              </div>
